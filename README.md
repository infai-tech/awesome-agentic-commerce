...
- [VulnFeed MCP](https://vulnfeed.novadyne.ai) - Dependency vulnerability scanner with EPSS scoring for AI agents. 9 MCP tools, x402 micropayments. Free tier available. ([GitHub](https://github.com/infai-tech/vulnfeed-mcp))
